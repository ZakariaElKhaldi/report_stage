...
\begin{titlepage}
  ...
  \vspace{1cm}
  \begin{center}
    % Enterprise logo/name with styling
    \begin{tikzpicture}
      \node[draw=primary, line width=1.5pt, rounded corners=5mm, inner sep=8mm] {
    ...
    {\fontsize{30}{36}\selectfont\textcolor{primary}{\textbf{RAPPORT DE STAGE}}\par}
    \vspace{0.8cm}
    ...
    \begin{tikzpicture}
      \node[draw=secondary, rounded corners=3mm, line width=1pt, fill=white, inner sep=6mm] {
        \begin{minipage}{0.8\textwidth}
          \centering
          {\large\textbf{Présenté par}}\\\vspace{0.3cm}
          {\Large\textbf{Zakaria el Khaldi}}\\\vspace{0.7cm}
          {\large\textbf{Formation :} [Formation]}\\\vspace{0.2cm}
    ...
    % Internship period with styling
    \begin{tikzpicture}
      \node[draw=accent, rounded corners=3mm, line width=1pt, fill=white, inner sep=5mm] {
        \begin{minipage}{0.7\textwidth}
          \centering
          {\large\textbf{Période de stage}}\\\vspace{0.3cm}
          {\large Du 5 mai 2025 au [Date de fin]}
        \end{minipage}
      };
    \end{tikzpicture}
    ...
    % Supervision information with styling
