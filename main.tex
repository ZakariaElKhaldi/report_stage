...
\begin{titlepage}
    ...
    \begin{minipage}{0.45\textwidth}
        ...
        {\large \textbf{Formation :} BTS DSI (Développement Système Informatique)}\\[0.2cm]
        {\large \textbf{Établissement :} Centre BTS Hay Hassani}
    \end{minipage}
    \hfill
    \begin{minipage}{0.45\textwidth}
        \flushright
...
Je suis également reconnaissant envers mon établissement, le Centre BTS Hay Hassani, et mes professeurs pour la qualité de l'enseignement reçu qui m'a permis d'aborder ce stage avec les compétences nécessaires.
